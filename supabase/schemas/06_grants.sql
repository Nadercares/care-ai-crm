...
grant all on sequence public.financial_ledger_id_seq to anon;
grant all on sequence public.financial_ledger_id_seq to authenticated;
grant all on sequence public.financial_ledger_id_seq to service_role;
